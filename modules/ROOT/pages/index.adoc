...
MuleSoft MCP Server integrates with MuleSoft Vibes and provides a set of agentic tools for direct access to your MuleSoft environment, enabling capabilities such as:
