...
Use APIkit flows to implement an API specification in a new integration project from an Anypoint Exchange asset.
...
|`groupId`
|The group ID of the API specification in Anypoint Exchange.
|Yes

|`assetId`
|The asset ID of the API specification in Anypoint Exchange.
|Yes

|`version`
|The version of the API specification, for example '1.4.0'.
|Yes

|`classifier`
|The classifier of the API specification. Fetched from Anypoint Exchange if not provided.
|No

|`type`
|The type or packaging of the API specification. Fetched from Anypoint Exchange if not provided.
|No

|`main`
|The main file of the API specification. Fetched from Anypoint Exchange if not provided.
|No
