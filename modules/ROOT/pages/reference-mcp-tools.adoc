...
----
{
  ...
  "arguments": {
    "apiSpec": "/Users/you/workspace/stripe-spec/openapi.yaml",
    "projectName": "Stripe Connector",
    "description": "Connector for syncing customers and handling charges/refunds.",
    "phases": [
      "ccm",
      "anypoint"
    ]
