...
|moduleUrl
|The URL of the DataWeave module file in the format `\file://<path>.dwl` or `jar://<path>.dwl` search documentation for. Use the `dataweave_get_project_metadata` tool to get the URL of a given module.
|Yes
