...
[IMPORTANT] 
If you have Anypoint Code Builder, stop here. Don't perform these steps. MuleSoft MCP Server is already installed and configured in Anypoint Code Builder.
