...
Refer to the xref:reference-mcp-tools.adoc[] for details on which tool requires which scopes. 
...
|===
|To...|Required Permission

|Use natural language prompts to develop and generate flows using Agentforce for Anypoint Code Builder Generative Flows. |Mule Developer Generative AI User
|===
...
|View and modify API configurations in the specified environment.|Manage APIs Configuration
...
|View API policies in the specified environment.|View Policies
|===
