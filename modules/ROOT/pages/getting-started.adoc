...
[IMPORTANT] 
If you have Anypoint Code Builder, stop here. Don't perform these steps. MuleSoft MCP Server is already installed and configured in MuleSoft Dev Agent in Anypoint Code Builder. 

Authentication happens through the user that's logged into Anypoint Code Builder. Any permissions that the user has, MuleSoft Dev Agent will assume. For more information about MuleSoft Dev Agent, see xref:anypoint-code-builder::api-ai-create-spec.adoc[].
