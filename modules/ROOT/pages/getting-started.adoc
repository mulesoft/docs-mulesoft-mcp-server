...
* xref:access-management::enabling-generative-ai.adoc[Enable Generative AI] access to: run the `generate_mule_flow` and `generate_api_spec` tools.
...
|Use natural language prompts to develop and generate flows using Anypoint Code Builder Generative Flows. |Mule Developer Generative AI User a|
