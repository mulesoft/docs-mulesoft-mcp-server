...
[IMPORTANT] 
====
If you have Anypoint Code Builder or Connector Builder, MuleSoft MCP Server is already installed and configured in MuleSoft Dev Agent. For more information, see xref:anypoint-code-builder::api-ai-create-spec[] and xref:connector-builder::index.adoc[].
====
...
See xref:access-management::permissions-by-product.adoc[] for more details on permissions. 
